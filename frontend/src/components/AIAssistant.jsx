  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 rounded-2xl bg-kodi-accent text-white shadow-kodi-accent-30 flex items-center justify-center hover:scale-105 transition-all duration-200 z-50"
      >
