    ...
    it('cra', () => {
        expect(
            parse(
                {
                    ...
                    'text-align': 'center',
                    '.logo': {
                        animation: 'Akodi-logo-spin infinite 20s linear',
                        height: '40vmin',
                        'pointer-events': 'none'
                    },
                    '.header': {
            ...
            [
                ...
                'App .logo{animation:Akodi-logo-spin infinite 20s linear;height:40vmin;pointer-events:none;}',
                ...
                '@keyframes Akodi-logo-spin{from{transform:rotate(0deg);}to{transform:rotate(360deg);}}'
            ].join('')
        );
    });
